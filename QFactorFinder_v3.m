function [QFactor] = QFactorFinder_v3(S21, center_freqs, f_range)
	...
	try
		...
		S21_3dB_freq(2, 2) = interp1(S21(center_freq_inds(2):find(f_range == 2.6005e9)), f_range(center_freq_inds(2):find(f_range == 2.6005e9)), S21_3dBs(2));
